...
window.StatsScreen = function StatsScreen({
  ...
  useEffectSt(() => {
    window.save(window.SK.goals, goals);
  }, [goals]);
  const goal = goals[selEx] || null;
  const rawData = [...history].reverse().flatMap(h => h.exercises.filter(e => e.name === selEx).map(e => ({
    date: h.date,
  ...
  function getGrouped() {
    if (period === 'seances') return rawData.map(d => ({
      label: window.dateFr(d.date),
      maxKg: d.maxKg,
      vol: d.vol,
      sets: d.sets,
    ...
    return Object.values(map).map(g => ({
      label: period === 'semaines' ? new Date(g.k).toLocaleDateString('fr-FR', {
        day: 'numeric',
        month: 'short'
  ...
  function buildTargetCurve(grouped) {
    ...
    for (let w = 0; w <= totalWeeks; w++) {
      ...
      pts.push({
        date: d,
        kg: Math.round((startKg + kgPerWeek * w) * 100) / 100,
  ...
  function saveGoal() {
    const kg = parseFloat(gKg);
    const reps = parseInt(gReps);
  ...
  function openGoalForm() {
    if (goal) {
      setGKg(String(goal.kg));
      setGReps(String(goal.reps));
      setGDate(goal.date);
    } else {
      setGKg('');
      setGReps('');
  ...
  const diffStyle = v => ({
    fontSize: 11,
    marginTop: 2,
    color: v > 0 ? '#22C55E' : v < 0 ? '#EF4444' : '#F59E0B'
  });
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  })), exNames.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 6,
  ...
  }, exNames.map(n => /*#__PURE__*/React.createElement("button", {
    key: n,
    onClick: () => setSelEx(n),
    style: {
      background: selEx === n ? '#1E1E22' : 'transparent',
      border: selEx === n ? '1px solid #333' : '1px solid transparent',
      borderRadius: 8,
      padding: '6px 14px',
      fontSize: 13,
      fontWeight: 600,
      cursor: 'pointer',
      fontFamily: 'inherit',
      color: selEx === n ? '#fff' : '#555',
      whiteSpace: 'nowrap',
      flexShrink: 0
    }
  }, n))), exNames.length === 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: 60,
      color: '#555',
  ...
  }, "Pas encore d'historique"), selEx && grouped.length === 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: 40,
      color: '#555',
  ...
  }, "Pas de donn\xE9es pour cet exercice"), selEx && grouped.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: S.card
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 14
  ...
  }, "Charge max"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 20,
      fontWeight: 700
    }
  }, last.maxKg, " kg", isPR && /*#__PURE__*/React.createElement("span", {
    style: {
      background: '#22C55E22',
      color: '#22C55E',
      fontSize: 10,
  ...
  }, "PR")), chargeDiff !== null && /*#__PURE__*/React.createElement("div", {
    style: diffStyle(chargeDiff)
  }, diffText(chargeDiff, ' kg'))), /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#111113',
      borderRadius: 10,
      padding: '10px 12px'
  ...
  }, "Volume dernier"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 20,
      fontWeight: 700
    }
  }, last.vol), volDiff !== null && /*#__PURE__*/React.createElement("div", {
    style: diffStyle(volDiff)
  }, diffText(volDiff, '%'))), /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#111113',
      borderRadius: 10,
      padding: '10px 12px'
  ...
  }, "S\xE9ances / sem."), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 20,
      fontWeight: 700
    }
  ...
  }, "Progression vol."), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 20,
      fontWeight: 700,
      color: totalProg >= 0 ? '#22C55E' : '#EF4444'
    }
  }, totalProg >= 0 ? '+' : '', totalProg, "%"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: '#555',
      marginTop: 2
    }
  }, "sur la p\xE9riode"))), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\u270E ", goal ? 'Modifier' : 'Définir')), !goal && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: '#444',
      textAlign: 'center',
  ...
  }, "Aucun objectif d\xE9fini"), goal && diff !== null && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      background: ahead ? '#22C55E11' : '#EF444411',
      border: `1px solid ${ahead ? '#22C55E33' : '#EF444433'}`,
      borderRadius: 10,
      padding: '10px 14px',
      marginBottom: 10,
      display: 'flex',
  ...
  }, ahead ? 'En avance' : 'En retard'), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      marginTop: 2,
      color: ahead ? '#22C55E' : '#EF4444'
    }
  }, diff > 0 ? '+' : '', diff, " kg vs la courbe cible")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 20,
      color: ahead ? '#22C55E' : '#EF4444'
    }
  }, ahead ? '↑' : '↓')), nextTarget && /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#1A1A2E',
  ...
  }, "Prochaine s\xE9ance cible"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 15,
      fontWeight: 700
    }
  }, nextTarget.kg.toFixed(2), " kg \xD7 4\xD7", goal.reps, " reps"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: '#666',
      marginTop: 2
    ...
    day: 'numeric',
    month: 'long'
  }), " \xB7 Deadline : ", deadlineLabel)), /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#111113',
      borderRadius: 10,
      padding: '10px 14px'
  ...
  }, "Progression vers l'objectif"), /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#222',
      borderRadius: 6,
      height: 8,
    ...
    style: {
      ...
      background: pctGoal >= 100 ? '#22C55E' : '#0D7A8A',
      transition: 'width .5s'
    }
  })), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, curKg, " kg"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontWeight: 700
    }
  ...
  }, goal.kg, " kg")))), showGoalForm && /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#111113',
      borderRadius: 10,
      padding: '14px',
    ...
    type: "number",
    value: gKg,
    onChange: e => setGKg(e.target.value),
    placeholder: "40"
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
  ...
  }, "vs pr\xE9c."))), /*#__PURE__*/React.createElement("tbody", null, [...rawData].reverse().map((d, i, arr) => {
    const prevD = arr[i + 1];
    ...
    }, d.vol), /*#__PURE__*/React.createElement("td", {
      style: {
        padding: '9px 4px',
        textAlign: 'center',
        color: vc,
