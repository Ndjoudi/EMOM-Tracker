...
const S = window.S;
const IC = window.IC;
window.PyramidGrid = function PyramidGrid({
  ex,
  onChange,
  onDone
}) {
  ...
  const cellBg = (r, c) => ({
    ...
    upcoming: '#0D7A8A11'
  })[status(r, c)] || 'transparent';
  const cellBd = (r, c) => ({
    active: '2px solid #F59E0B',
    done: '1px solid #22C55E44',
    upcoming: '1px solid #0D7A8A55'
  })[status(r, c)] || '1px solid #2A2A2E';
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Repos \u2014 ligne ", curRow + 1), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 26,
      fontWeight: 800,
      color: '#0D7A8A',
  ...
  }, "Ligne ", curRow + 1, "/", rows), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      fontWeight: 700,
      color: S.orange
    }
  }, "S\xE9rie ", curCol + 1, "/", cols)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 40,
      fontWeight: 800,
      color: S.orange,
  ...
  }, "Suivant"))) : allDone ? /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#22C55E11',
  ...
  }, "Pyramide termin\xE9e") : /*#__PURE__*/React.createElement("button", {
    style: {
      ...S.btn,
      width: '100%',
      padding: '12px',
    ...
    onClick: start
  }, /*#__PURE__*/React.createElement(IC.play, null), " Pyramide \u2014 ", cols, " \xD7 ", fmt(X))), rows > 1 && /*#__PURE__*/React.createElement("button", {
    onClick: copyRow1,
    style: {
      background: '#1E1E22',
  ...
  }, "\u2193 Copier ligne 1 sur toutes"), /*#__PURE__*/React.createElement("div", {
    style: {
      overflowX: 'auto'
    }
    ...
    length: cols
  }, (_, c) => /*#__PURE__*/React.createElement("th", {
    key: c,
    style: {
      width: colW,
      fontSize: 10,
  ...
  }, "S", c + 1)))), /*#__PURE__*/React.createElement("tbody", null, Array.from({
    length: rows
  }, (_, r) => /*#__PURE__*/React.createElement("tr", {
    key: r
